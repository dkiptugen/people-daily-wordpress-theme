!function(e, t) {
    ...
    var h = function(n) {
        ...
        }, Y = /HTML$/i, Q = /^(?:input|select|textarea|button)$/i, J = /^h\d$/i, K = /^[^{]+\{\s*\[native \w/, Z = /^(?:#([\w-]+)|(\w+)|\.([\w-]+))$/, ee = /[+~]/, te = new RegExp("\\\\([\\da-f]{1,6}" + M + "?|(" + M + ")|.)", "ig"), re = /([\0-\x1f\x7f]|^-?\d)|^-$|[^\0-\x1f\x7f-\uFFFF\w-]/g, ie = function(e, t) {
            ...
            if (!r && ((e ? e.ownerDocument || e : m) !== C && T(e), e = e || C, E)) {
                ...
                if (d.qsa && !A[t + " "] && (!v || !v.test(t)) && (1 !== p || "object" !== e.nodeName.toLowerCase())) {
                    if (c = t, f = e, 1 === p && U.test(t)) {
                        for ((s = e.getAttribute("id")) ? s = s.replace(re, ie) : e.setAttribute("id", s = k), 
                        o = (l = h(t)).length; o--; ) l[o] = "#" + s + " " + xe(l[o]);
                ...
                CHILD: function(h, e, t, g, v) {
                    ...
                    return 1 === g && 0 === v ? function(e) {
                        ...
                        if (c) {
                            ...
                            !1 === d) for (;(a = ++s && a && a[l] || (d = s = 0) || u.pop()) && ((x ? a.nodeName.toLowerCase() !== f : 1 !== a.nodeType) || !++d || (p && ((i = (o = a[k] || (a[k] = {}))[a.uniqueID] || (o[a.uniqueID] = {}))[h] = [ S, d ]), 
                            a !== e)); ) ;
        ...
        function be(s, e, t) {
            ...
            return e.first ? function(e, t, n) {
                ...
                } else for (;e = e[u]; ) if (1 === e.nodeType || f) if (i = (o = e[k] || (e[k] = {}))[e.uniqueID] || (o[e.uniqueID] = {}), 
        ...
        return me.prototype = b.filters = b.pseudos, b.setFilters = new me(), h = se.tokenize = function(e, t) {
            ...
            if (!a) {
                for (n = (t = t || h(e)).length; n--; ) (a = Ee(t[n]))[k] ? i.push(a) : o.push(a);
    ...
    k.extend({
        ...
        promise: function(e, t) {
            ...
            for ("string" != typeof e && (t = e, e = void 0), e = e || "fx"; a--; ) (n = Q.get(o[a], e + "queueHooks")) && n.empty && (r++, 
            n.empty.add(s));
    ...
    function le(e, t, n, r) {
        ...
        if (c && c[3] !== l) {
            for (u /= 2, l = l || c[3], c = +u || 1; a--; ) k.style(e, t, c + l), (1 - o) * (1 - (o = s() / u || .5)) <= 0 && (a = 0), 
            c /= o;
    ...
    function we(e, t, n, r, i) {
        for (var o, a, s, u, l, c, f = t.createDocumentFragment(), p = [], d = 0, h = e.length; d < h; d++) if ((o = e[d]) || 0 === o) if ("object" === w(o)) k.merge(p, o.nodeType ? [ o ] : o); else if (be.test(o)) {
            ...
            u = ge[s] || ge._default, a.innerHTML = u[1] + k.htmlPrefilter(o) + u[2], c = u[0]; c--; ) a = a.lastChild;
            k.merge(p, a.childNodes), (a = f.firstChild).textContent = "";
        } else p.push(t.createTextNode(o));
        for (f.textContent = "", d = 0; o = p[d++]; ) if (r && -1 < k.inArray(o, r)) i && i.push(o); else if (l = oe(o), 
    ...
    k.event = {
        ...
        add: function(t, e, n, r, i) {
            ...
            if (v) for (n.handler && (n = (o = n).handler, i = o.selector), i && k.find.matchesSelector(ie, i), 
            n.guid || (n.guid = k.guid++), (u = v.events) || (u = v.events = {}), (a = v.handle) || (a = v.handle = function(e) {
                return void 0 !== k && k.event.triggered !== e.type ? k.event.dispatch.apply(t, arguments) : void 0;
            }), l = (e = (e || "").match(R) || [ "" ]).length; l--; ) d = g = (s = Ee.exec(e[l]) || [])[1], 
            h = (s[2] || "").split(".").sort(), d && (f = k.event.special[d] || {}, d = (i ? f.delegateType : f.bindType) || d, 
        ...
        remove: function(e, t, n, r, i) {
            ...
            if (v && (u = v.events)) {
                for (l = (t = (t || "").match(R) || [ "" ]).length; l--; ) if (d = g = (s = Ee.exec(t[l]) || [])[1], 
                h = (s[2] || "").split(".").sort(), d) {
        ...
        dispatch: function(e) {
            ...
            if (s.delegateTarget = this, !c.preDispatch || !1 !== c.preDispatch.call(this, s)) {
                for (a = k.event.handlers.call(this, s, l), t = 0; (i = a[t++]) && !s.isPropagationStopped(); ) for (s.currentTarget = i.elem, 
    ...
    k.Animation = k.extend(dt, {
        ...
        tweener: function(e, t) {
            for (var n, r = 0, i = (e = m(e) ? (t = e, [ "*" ]) : e.match(R)).length; r < i; r++) n = e[r], 
    ...
    k.fn.extend({
        ...
        attr: function(e, t, n) {
            ...
            if (3 !== o && 8 !== o && 2 !== o) return void 0 === e.getAttribute ? k.prop(e, t, n) : (1 === o && k.isXMLDoc(e) || (i = k.attrHooks[t.toLowerCase()] || (k.expr.match.bool.test(t) ? ht : void 0)), 
    ...
    k.fn.extend({
        ...
        toggleClass: function(i, t) {
            ...
            return "boolean" == typeof t && a ? t ? this.addClass(i) : this.removeClass(i) : m(i) ? this.each(function(e) {
                ...
                var e, t, n, r;
                if (a) for (t = 0, n = k(this), r = bt(i); e = r[t++]; ) n.hasClass(e) ? n.removeClass(e) : n.addClass(e); else void 0 !== i && "boolean" != o || ((e = xt(this)) && Q.set(this, "__className__", e), 
    ...
    2 === Vt.childNodes.length), k.parseHTML = function(e, t, n) {
        ...
        setOffset: function(e, t, n) {
            ...
            u = k.css(e, "left"), i = ("absolute" === l || "fixed" === l) && -1 < (o + u).indexOf("auto") ? (a = (r = c.position()).top, 
            r.left) : (a = parseFloat(o) || 0, parseFloat(u) || 0), m(t) && (t = t.call(e, n, k.extend({}, s))), 
    ...
    var g = /\+/g, h = a.cookie = function(e, g, i) {
        if (void 0 !== g && !a.isFunction(g)) {
            if ("number" == typeof (i = a.extend({}, h.defaults, i)).expires) {
                var j = i.expires, k = i.expires = new Date();
                k.setTime(+k + 864e5 * j);
            }
            return document.cookie = [ b(e), "=", function(a) {
                return b(h.json ? JSON.stringify(a) : String(a));
            }(g), i.expires ? "; expires=" + i.expires.toUTCString() : "", i.path ? "; path=" + i.path : "", i.domain ? "; domain=" + i.domain : "", i.secure ? "; secure" : "" ].join("");
        }
    ...
    function a(e, argument_1) {
        var o = "top" === (1 < arguments.length && void 0 !== argument_1 ? argument_1 : "top") ? "scrollTop" : "scrollLeft", i = e.nodeName;
        if ("BODY" !== i && "HTML" !== i) return e[o];
        var n = e.ownerDocument.documentElement;
        return (e.ownerDocument.scrollingElement || n)[o];
    }
    function l(e, t, argument_2) {
        var o = 2 < arguments.length && void 0 !== argument_2 && argument_2, i = a(t, "top"), n = a(t, "left"), r = o ? -1 : 1;
    ...
    function b(e) {
        var t = e.ownerDocument.documentElement, o = u(e, t), i = J(t.clientWidth, window.innerWidth || 0), n = J(t.clientHeight, window.innerHeight || 0), r = a(t), p = a(t, "left");
        return c({
    ...
    function y(e, t, i, r) {
        ...
        if ("viewport" === r) p = b(s); else {
            var a;
            "scrollParent" === r ? "BODY" === (a = n(o(t))).nodeName && (a = e.ownerDocument.documentElement) : a = "window" === r ? e.ownerDocument.documentElement : r;
            var l = u(a, s);
            if ("HTML" !== a.nodeName || w(s)) p = l; else {
    ...
    function v(e, t, o, i, n, argument_5) {
        var r = 5 < arguments.length && void 0 !== argument_5 ? argument_5 : 0;
    ...
    function q(e, argument_1) {
        var t = 1 < arguments.length && void 0 !== argument_1 && argument_1, o = ae.indexOf(e), i = ae.slice(o + 1).concat(ae.slice(0, o));
        ...
        return (a = a.map(function(e, i) {
            ...
            return e.reduce(function(e, t) {
                ...
                return function(e, t, o, i) {
                    var s, n = e.match(/((?:\-|\+)?\d*\.?\d*)(.*)/), r = +n[1], p = n[2];
                    if (!r) return e;
                    if (0 !== p.indexOf("%")) return "vh" !== p && "vw" !== p ? r : ("vh" === p ? J(document.documentElement.clientHeight, window.innerHeight || 0) : J(document.documentElement.clientWidth, window.innerWidth || 0)) / 100 * r;
                    switch (p) {
                      case "%p":
                        s = o;
                        break;
    ...
    var i, oe = Q && window.Promise ? function(e) {
        var t = !1;
        return function() {
        ...
        for (var t, o = 1; o < arguments.length; o++) for (var i in t = arguments[o]) Object.prototype.hasOwnProperty.call(t, i) && (e[i] = t[i]);
        return e;
    }, de = [ "auto-start", "auto", "auto-end", "top-start", "top", "top-end", "right-start", "right", "right-end", "bottom-end", "bottom", "bottom-start", "left-end", "left", "left-start" ], ae = de.slice(3), le_FLIP = "flip", le_CLOCKWISE = "clockwise", le_COUNTERCLOCKWISE = "counterclockwise", fe = function() {
        function t(o, i) {
        ...
        modifiers: {
            ...
            arrow: {
                ...
                fn: function(e, o) {
                    ...
                    return v = J(_(s[l] - u, v), 0), e.arrowElement = n, e.offsets.arrow = (pe(i = {}, m, Math.round(v)), 
                    pe(i, h, ""), i), e;
                },
                element: "[x-arrow]"
            },
            flip: {
                ...
                fn: function(e, t) {
                    ...
                    return p.forEach(function(s, d) {
                        ...
                        (m || b || y) && (e.flipped = !0, (m || b) && (i = p[d + 1]), y && (r = function(e) {
                            return "end" === e ? "start" : "start" === e ? "end" : e;
                        }(r)), e.placement = i + (r ? "-" + r : ""), e.offsets.popper = se({}, e.offsets.popper, S(e.instance.popper, e.offsets.reference, e.placement)), 
            ...
            applyStyle: {
                ...
                onLoad: function(e, t, o, i, n) {
                    var r = O(0, t, e), p = v(o.placement, r, t, e, o.modifiers.flip.boundariesElement, o.modifiers.flip.padding);
    ...
    var r, n, o, a, c, u, _, m, p, v, y, E, C, T, I, N, O, k, P, j, H, L, R, x, W, U, q, F, Q, V, X, ot, st, at, lt, ct, ht, ut, ft, dt, gt, _t, mt, pt, Ct, Tt, bt, St, It, At, Dt, wt, Nt, Ot, kt, Pt, Rt, Wt, qt, Jt, Zt, Gt, $t, Xt, te, ee, ne, ie, re, oe, le, ce, he, ge, _e, me, pe, ve, ye, Ee, Ce, Te, be, Se, Ie, Ae, De, Ne, Oe, ke, He, Le, We, Ue, qe, Fe, Ke, Me, Qe, Be, Ve, Ye, $e, Xe, tn, en, nn, rn, on, sn, an, ln, hn, dn, gn, mn, Cn, Tn, bn, Sn, In, An, Dn, Nn, Ln, Rn, qn, Fn = function(i) {
        ...
        return t.close = function(t) {
            ...
            return e && (n = document.querySelector(e)), n = n || r(t).closest(".alert")[0];
    ...
    T = "active", "btn", I = '[data-toggle^="button"]', '[data-toggle="buttons"]', "input", 
    ".active", N = ".btn", O = {
    ...
    }, "carousel", V = "active", "slide", "carousel-item-right", "carousel-item-left", 
    "carousel-item-next", "carousel-item-prev", ".active", X = ".active.carousel-item", 
    ".carousel-item", ".carousel-item-next, .carousel-item-prev", ".carousel-indicators", 
    "[data-slide], [data-slide-to]", '[data-ride="carousel"]', ot = function() {
        function o(t, e) {
            ...
            this._element = P(t)[0], this._indicatorsElement = this._element.querySelector(".carousel-indicators"), 
        ...
        return t.next = function() {
            ...
            t || (this._isPaused = !0), this._element.querySelector(".carousel-item-next, .carousel-item-prev") && (Fn.triggerTransitionEnd(this._element), 
            ...
            if (r = t === q ? (n = "carousel-item-left", i = "carousel-item-next", "left") : (n = "carousel-item-right", 
            i = "carousel-item-prev", "right"), l && P(l).hasClass(V)) this._isSliding = !1; else if (!this._triggerSlideEvent(l, r).isDefaultPrevented() && s && l) {
    ...
    }(), P(document).on(Q.CLICK_DATA_API, "[data-slide], [data-slide-to]", ot._dataApiClickHandler), 
    ...
    }, gt = "show", _t = "collapse", mt = "collapsing", pt = "collapsed", "width", "height", 
    ".show, .collapsing", Ct = '[data-toggle="collapse"]', Tt = function() {
        ...
        return t.toggle = function() {
            ...
            var t, e, n = this;
            if (!(this._isTransitioning || st(this._element).hasClass(gt) || (this._parent && 0 === (t = [].slice.call(this._parent.querySelectorAll(".show, .collapsing")).filter(function(t) {
            ...
            if (!this._isTransitioning && st(this._element).hasClass(gt)) {
                ...
                if (st(this._element).trigger(e), !e.isDefaultPrevented()) {
                    ...
                    if (0 < i) for (var r = 0; r < i; r++) {
                        ...
                        null !== s && (st([].slice.call(document.querySelectorAll(s))).hasClass(gt) || st(o).addClass(pt).attr("aria-expanded", !1));
                    }
            ...
            return st(this._element).hasClass("width") ? "width" : "height";
        }, t._getParent = function() {
            var n = this, t = null;
            Fn.isElement(this._config.parent) ? (t = this._config.parent, void 0 !== this._config.parent.jquery && (t = this._config.parent[0])) : t = document.querySelector(this._config.parent);
    ...
    }, kt = "disabled", Pt = "show", "dropup", "dropright", "dropleft", Rt = "dropdown-menu-right", 
    "position-static", Wt = '[data-toggle="dropdown"]', ".dropdown form", qt = ".dropdown-menu", 
    ".navbar-nav", ".dropdown-menu .dropdown-item:not(.disabled):not(:disabled)", "top-start", 
    "top-end", "bottom-start", "bottom-end", "right-start", "left-start", Jt = {
        offset: 0,
        flip: !0,
        ...
        return t.toggle = function() {
                ...
                if (c._clearMenus(), !e) {
                    ...
                    if (bt(t).trigger(i), !i.isDefaultPrevented()) {
                        if (!this._inNavbar) {
                            ...
                            void 0 !== this._config.reference.jquery && (r = this._config.reference[0])), "scrollParent" !== this._config.boundary && bt(t).addClass("position-static"), 
                            this._popper = new h(r, this._menu, this._getPopperConfig());
                        }
                        "ontouchstart" in document.documentElement && 0 === bt(t).closest(".navbar-nav").length && bt(document.body).children().on("mouseover", null, bt.noop), 
            ...
            var t = bt(this._element.parentNode), e = "bottom-start";
            return t.hasClass("dropup") ? (e = "top-start", bt(this._menu).hasClass(Rt) && (e = "top-end")) : t.hasClass("dropright") ? e = "right-start" : t.hasClass("dropleft") ? e = "left-start" : bt(this._menu).hasClass(Rt) && (e = "bottom-end"), 
            e;
    ...
    }, "modal-scrollbar-measure", "modal-backdrop", le = "modal-open", ce = "fade", 
    he = "show", ".modal-dialog", '[data-toggle="modal"]', '[data-dismiss="modal"]', 
    ge = ".fixed-top, .fixed-bottom, .is-fixed, .sticky-top", _e = ".sticky-top", me = function() {
        ...
        return t.toggle = function(t) {
            ...
            if (!this._isTransitioning && !this._isShown) {
                ...
                this._setEscapeEvent(), this._setResizeEvent(), $t(this._element).on(oe.CLICK_DISMISS, '[data-dismiss="modal"]', function(t) {
                    return e.hide(t);
            ...
            $t(e).each(function(t, e) {
                ...
                void 0 !== n && $t(e).css("margin-right", n).removeData("margin-right");
            });
    ...
    }(), $t(document).on(oe.CLICK_DATA_API, '[data-toggle="modal"]', function(t) {
    ...
    }, Oe = "fade", ke = "show", ".tooltip-inner", ".arrow", He = "hover", Le = "focus", 
    "click", "manual", We = function() {
        function i(t, e) {
        ...
        return t.enable = function() {
            ...
            if (pe(this.element).trigger(i), !i.isDefaultPrevented()) {
                ...
                this._activeTrigger.click = !1, this._activeTrigger[Le] = !1, this._activeTrigger[He] = !1, 
            ...
            this.setElementContent(pe(t.querySelectorAll(".tooltip-inner")), this.getTitle()), 
    ...
    }), "fade", ".popover-header", ".popover-body", $e = {
        HIDE: "hide" + Ke,
        HIDDEN: "hidden" + Ke,
        SHOW: "show" + Ke,
        SHOWN: "shown" + Ke,
    ...
    }, "dropdown-item", hn = "active", '[data-spy="scroll"]', ".active", dn = ".nav, .list-group", 
    gn = ".nav-link", ".nav-item", mn = ".list-group-item", ".dropdown", ".dropdown-item", 
    ".dropdown-toggle", "offset", Cn = "position", Tn = function() {
        function n(t, e) {
            var n = this;
        ...
        return t.refresh = function() {
            var e = this, t = this._scrollElement === this._scrollElement.window ? "offset" : Cn, r = "auto" === this._config.method ? t : this._config.method, o = r === Cn ? this._getScrollTop() : 0;
            ...
            n.hasClass("dropdown-item") ? (n.closest(".dropdown").find(".dropdown-toggle").addClass(hn), 
            n.addClass(hn)) : (n.addClass(hn), n.parents(dn).prev(gn + ", " + mn).addClass(hn), 
            n.parents(dn).prev(".nav-item").children(gn).addClass(hn)), tn(this._scrollElement).trigger(ln.ACTIVATE, {
                relatedTarget: e
            });
        }, t._clear = function() {
            var t = [].slice.call(document.querySelectorAll(this._selector));
            tn(t).filter(".active").removeClass(hn);
        }, n._jQueryInterface = function(e) {
            return this.each(function() {
    ...
    }, "dropdown-menu", Nn = "active", "disabled", "fade", "show", ".dropdown", ".nav, .list-group", 
    Ln = ".active", Rn = "> li > .active", '[data-toggle="tab"], [data-toggle="pill"], [data-toggle="list"]', 
    ".dropdown-toggle", "> .dropdown-menu .active", qn = function() {
        function i(t) {
            this._element = t;
        }
        var t = i.prototype;
        return t.show = function() {
            var n = this;
            if (!(this._element.parentNode && this._element.parentNode.nodeType === Node.ELEMENT_NODE && bn(this._element).hasClass(Nn) || bn(this._element).hasClass("disabled"))) {
                var t, i, e = bn(this._element).closest(".nav, .list-group")[0], r = Fn.getSelectorFromElement(this._element);
                if (e) {
            ...
            var i = this, r = ("UL" === e.nodeName ? bn(e).find(Rn) : bn(e).children(Ln))[0], o = n && r && bn(r).hasClass("fade");
            if (r && o) {
            ...
            Fn.reflow(t), bn(t).addClass("show"), t.parentNode && bn(t.parentNode).hasClass("dropdown-menu")) {
                var r = bn(t).closest(".dropdown")[0];
                if (r) {
    ...
    }(), bn(document).on(Dn.CLICK_DATA_API, '[data-toggle="tab"], [data-toggle="pill"], [data-toggle="list"]', function(t) {
